...
#define TOUCH_DOWN_POSITION_R 570
#define STAND_UP_POSITION_L 325
#define STAND_UP_POSITION_R 585 // 910-585
#define LIFT_OFF_POSITION_L 290
#define LIFT_OFF_POSITION_R 620
