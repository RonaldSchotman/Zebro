...
#define VREGS_MOTION_TOUCH_DOWN_POSITION_A 121
#define VREGS_MOTION_TOUCH_DOWN_POSITION_B 122
#define VREGS_STAND_UP_POSITION_A 123
...
#define VREGS_POSITION_SETPOINT 155
...
#define VREGS_POSITION_DELTA 161
#endif
